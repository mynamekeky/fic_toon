          ...
          <div className="border rounded-lg pt-3 pb-6 px-5 shadow-sm bg-white">
            <div className="flex justify-between text-center font-bold">
              <div>
                ...
                {item.roleAs === "Hero" ? (
                  <p className="text-2xl">พระเอก</p>
                ) : item.roleAs === "Heroine" ? (
                  <p className="text-2xl">นางเอก</p>
                ) : item.roleAs === "Villain" ? (
                  <p className="text-2xl">ตัวร้าย</p>
                ) : (
                  <p className="text-2xl">ตัวละครหลัก</p>
                )}
              </div>
              <div>

                {item.work.type == "CARTOON" ? (
